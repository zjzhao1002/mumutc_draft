...
\begin{figure}
    ...
    \includegraphics[width=0.31\textwidth]{2dbound.pdf}
    \includegraphics[width=0.31\textwidth]{2dbound.pdf}
    \caption{The 2-D $2\sigma$ bounds are shown.\xznote{Currently using 0.03 as reference value, need to be updated.}}\label{fig:cll2d}
\end{figure}
