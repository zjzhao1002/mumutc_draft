...
\begin{enumerate}
    ...
    On the other hand, $C_{qe}$ is independent from $C_{lq}^{(1)}$.
...
At a such high energy, we can expect two energetic jets to be observed at the detector for either signal or background events. 
